...
<meta charset="utf-8">
    ...
    <title>About- | Webdeves Academy -</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
      <?php include('./resources/view/layout/head.php'); ?>
<head>
...
<body class="body__wrapper">
    ...
    <div id="back__preloader">
        ...
        <div class="back__loader_logo">
            <img src="img/pre.png" alt="Preload">
        </div>
    </div>
    </div>
    <!-- pre loader area end -->
...
<?php include('./resources/view/layout/header.php'); ?>



        <!--=====  End of landing header area  ======-->
        ...
        <div class="mobile-off-canvas-active">
            ...
            <div class="header-mobile-aside-wrap">
                        ...
                        <nav>
                            <ul class="mobile-menu">
                                ...
                                <li class="menu-item-has-children "><a href="#">Alumni</a>
                                    <ul class="dropdown">
                                        <li><a href="students-projects.html">Students Projects</a></li>
                                        <li><a href="#">Community</a></li>
                                    </ul>
                                </li>

                                <li class="menu-item-has-children "><a href="faq.html">FAQ</a>
                                </li>

                                <li><a class="menu-item-has-children" href="#">Blog</a></li>

                                <li><a class="menu-item-has-children" href="contact.html">Contact Us</a></li>
                            </ul>
                        </nav>
                ...
                <div class="mobile-curr-lang-wrap">
                    <p>Office Address: 56 Azikiwe Road, beside Union Bank, Aba, Abia State.</p>
                </div>
                <div class="mobile-social-wrap">
                    <a href="https://facebook.com/webdevesacademy" target="_blank"><i class="icofont-facebook"></i></a>
                    <a href="https://twitter.com/webdeves" target="_blank"><i class="icofont-twitter"></i></a>
                    <a href="https://instagram.com/webdevesacademy" target="_blank"><i
                            class="icofont-instagram"></i></a>
                    <a href="https://youtube.com/@webdevesacademy6989" target="_blank"><i
        ...
        <div class="img-banner" data-aos="fade-up">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="breadcrumb__content__wraper">
                            <div class="breadcrumb__title">
                                <h2 class="heading text-light">About Webdeves Academy</h2>
                            </div>
        ...
        <div class="aboutarea__5 sp_bottom_100 sp_top_100 bg-light">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6" data-aos="fade-up">
                        <div class="aboutarea__5__img" data-tilt>
                            <img src="img/about/webdeves-Academy.jpg" alt="about" class="top-10">
                        </div>
                    </div>

                    <div class="col-xl-6 col-lg-6" data-aos="fade-up " style="color:#170F2F;">
                        <div class="aboutarea__content__wraper__5">
                            <div class="section__title">
                                ...
                                <div class="section__title__heading ">
                                    <h2 style="color:#170F2F;">Welcome to the best tech Academy</h2>
                                </div>
                            </div>
                            <div class="about__text__5">
                                <p style="color:#170F2F;">Founded with a passion for innovation and impact, Webdeves
                                    Academy is a premier technology institution offering high-quality training in
                                    digital skills both online and in-person. Our programs cover a broad spectrum of
                                    disciplines, including Cybersecurity, Data Analysis, Software Development, UI/UX
                                    Design, Web Development, CAD/CAM, and more.</p>
                            </div>
                            ...
                            <div class="aboutarea__5__small__icon__wraper">
                                ...
                                <div class="aboutarea__small__heading" style="color:#170F2F;">
                                    <span>Professional And Experienced </span> Since 2018
                                </div>

                            </div>

                            <!-- <div class="aboutarea__para__5">
                                <p style="color:#170F2F;">What sets us apart is our commitment to our students — their growth, success, and transformation are at the core of everything we do. We combine modern teaching methodologies, personalized advisory systems, and real-world projects to ensure every learner is equipped not just with skills, but with experience and confidence.</p>
                            </div> -->

                            <div class="aboutarea__bottom__button__5">
                                <a class="default__button" href="registration.html"> Register
                ...
                <div class="animate__content__wrap">
                    ...
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3><a href="data-analysis.html">Data science</a></h3>
                            <p>Start your tech career as <br> a data analysist</p>
                        </div>
                    ...
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3><a href="frontend_development.html">Front-End</a></h3>
                            <p>Become front-end developer <br> today within few months</p>
                        </div>
                        <div class="service__small__img">
                            <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3><a href="backend_development.html">Back-End</a></h3>
                            <p>Start your tech career as <br>Back-End engineer</p>
                        </div>
                        <div class="service__small__img">
                            <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3><a href="graphics-design.html">Graphics Design</a></h3>
                            <p>Learn how to design using <br> Corel Draw, Photoshop and <br> Illustrator.</p>
                        </div>
                        <div class="service__small__img">
                            <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3><a href="computer-basics.html">Computer Basics</a></h3>
                            <p>Learn how to use a computer <br> and Ms Packages</p>
                        </div>
                        <div class="service__small__img">
                            <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3><a href="digital_marketing.html">Digital Marketing</a></h3>
                            <p>Learn & position yourself for <br> digital marketing opportunities</p>
                        </div>
                        <div class="service__small__img">
                            <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 about__wrap__content" data-aos="fade-up">
                        ...
                        <div class="populerarea__content__wraper__2">
                            <div class="section__title ">
                                <div class="section__title__button">
                                    <div class="default__small__button">Trusted Academy </div>
                                </div>
                                <div class="section__title__heading">
                                    <h2>Discover Webdeves Acadamy</h2>
                                </div>
                            </div>

                            <div class="populerarea__content__2">
                                <p class="populerarea__para__1">We foster a strong and supportive community that
                                    continues even after graduation. Our Alumni Network connects past students with
                                    career opportunities, mentorship, and collaborative projects, while our Endowment
                                    Fund supports underrepresented talents and expands access to quality tech education.
                                </p>
                                <p class="populerarea__para__2">At Webdeves Academy, we are passionate about empowering
                                    individuals with the knowledge and skills to thrive in the fast-paced world of
                                    technology. Our comprehensive and cutting-edge courses are designed to prepare
                                    students for successful careers in the ever-evolving tech industry.</p>
                            </div>
                            <div class="populerarea__button__2">
                                <a class="default__button" href="registration.html">Register Now
                                    <i class="icofont-long-arrow-right"></i>
                                </a>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up">
                                <div class="single__service">
                                    <div class="service__img">
                                        ...
                                        <div class="service__bg__img">
                                            <svg class="service__icon__bg" fill="none" xmlns="video-btn">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M63.3775 44.4535C54.8582 58.717 39.1005 53.2202 23.1736 47.5697C7.2467 41.9192 -5.18037 32.7111 3.33895 18.4477C11.8583 4.18418 31.6595 -2.79441 47.5803 2.85105C63.5011 8.49652 71.8609 30.2313 63.3488 44.4865L63.3775 44.4535Z"
                                                    fill="#5F2DED" fill-opacity="0.05" />
                                            </svg>
                                    ...
                                    <div class="service__content service__content__2">
                                        ...
                                        <p>To empower individuals through inclusive, modern, and practical digital
                                            education—bridging the gap between potential and opportunity through
                                            mentorship, community building, and transformative learning experiences.</p>
                                    </div>
                                ...
                                <div class="single__service">
                                    ...
                                    <div class="service__content service__content__2">
                                        <h3><a>Our Values</a></h3>
                                        <div class="aboutarea__list__2">
                                            <ul>
                                                <li style="color: white;">
                                                    <i class="icofont-check"></i> Student-Centered
                                                </li>

                                                <li style="color: white;">
                                                    <i class="icofont-check"></i> Innovation
                                                </li>

                                                <li style="color: white;">
                                                    <i class="icofont-check"></i>Community Impact
                                                </li>

                                                <li style="color: white;">
                                                    <i class="icofont-check"></i>Integrity
                                                </li>
                                                <li style="color: white;">
                                                    <i class="icofont-check"></i>Inclusiveness
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up">
                                <div class="single__service ss_margin">
                                    <div class="service__img">
                                        <svg class="service__icon" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M28.525 44.0499H20.4753C18.7037 44.0499 17.2625 42.7046 17.2625 41.0509C17.2625 36.723 15.7895 32.4935 13.115 29.1417C11.2743 26.835 10.3045 24.0912 10.3103 21.2067C10.3172 17.7711 11.7888 14.4906 14.4541 11.9697C17.1201 9.44796 20.6146 8.03229 24.2939 7.98346C28.1232 7.9323 31.7312 9.28502 34.4566 11.7915C37.1864 14.302 38.6898 17.6547 38.6898 21.2322C38.6898 24.0423 37.7594 26.7272 35.9993 28.9965C33.2113 32.5912 31.7377 36.7597 31.7377 41.0511C31.7377 42.7046 30.2964 44.0499 28.525 44.0499ZM24.5008 10.6603C24.4454 10.6603 24.3904 10.6607 24.3349 10.6614C18.3004 10.7416 13.1927 15.5731 13.1814 21.2117C13.1767 23.5138 13.9501 25.7029 15.418 27.5424C18.4589 31.3533 20.1335 36.1507 20.1335 41.0509C20.1335 41.2278 20.2869 41.3716 20.4752 41.3716H28.5249C28.7133 41.3716 28.8665 41.2278 28.8665 41.051C28.8665 36.1921 30.5286 31.4809 33.6733 27.4265C35.0768 25.6168 35.8187 23.4749 35.8187 21.2321C35.8187 18.3773 34.6191 15.7019 32.4409 13.6987C30.3067 11.7359 27.4925 10.6603 24.5008 10.6603Z"
                                                fill="#5F2DED" />
                                            <path d="M34.5884 35.3186H14.4117V37.9969H34.5884V35.3186Z"
                                                fill="#5F2DED" />
                                            <path
                                                d="M23.8501 30.4466L21.4301 29.0054L24.8268 24.0417H21.5536C21.0311 24.0417 20.5498 23.7768 20.297 23.3501C20.0444 22.9235 20.0602 22.4024 20.3384 21.9897L25.0805 14.9543L27.5109 16.38L24.1519 21.3634H27.4464C27.9708 21.3634 28.4533 21.63 28.7053 22.059C28.9573 22.4879 28.9385 23.0109 28.6564 23.4232L23.8501 30.4466Z"
                                                fill="#FFB31F" />
                                            <path d="M25.9355 2.17908H23.0645V6.19654H25.9355V2.17908Z"
                                                fill="#5F2DED" />
                                            <path
                                                d="M10.6816 6.93133L8.65027 8.8241L11.6922 11.6649L13.7235 9.77218L10.6816 6.93133Z"
                                                fill="#5F2DED" />
                                    ...
                                    <div class="service__content service__content__2">
                                        ...
                                        <p>To be Africa’s most student-focused and impact-driven tech
                                            academy—cultivating a future generation of innovators, creators, and
                                            problem-solvers equipped to lead in a digital world. </p>
                                    </div>
                                ...
                                <div class="single__service">
                                    ...
                                    <div class="service__content service__content__2">
                                        ...
                                        <div class="aboutarea__list__2">
                                            <p>
                                                To build a world-class digital skills academy that empowers individuals
                                                with the tools, knowledge, and mentorship they need to thrive in the
                                                modern tech ecosystem—while fostering community, innovation, and
                                                long-term impact through alumni and social projects.
                                            </p>
                                        </div>
                                    </div>
        ...
        <section style="background-color: #fbfbfb !important;">
            <div class="brandarea sp_bottom_60" style="background-color: #fbfbfb; padding-top: 50px;">
                <div class="container">
                        ...
                        <div class="col-xl-12">
                            <div class="section__title text-center">
                                ...
                                <div class="section__title__heading heading__underline">
                                    <h2 style="color: #0C0E2B;">Trusted Companies We Have Worked With</h2>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="brandarea__wraper" data-aos="fade-up">
                            ...
                            <div class="brandarea__img">
                                <img src="img/brand/brand_7.jpg" alt="brand">
                            </div>
                            <div class="brandarea__img">
        ...
        <!-- <div class="testmonialarea sp_top_100 sp_bottom_110">
            <div class="container">
                <div class="row" data-aos="fade-up">
                    <div class="section__title text-center">
                        <div class="section__title__button">
                            <div class="default__small__button">What The Say</div>
                        </div>
                        <div class="section__title__heading heading__underline">
                ...
                <div class="row row__custom__class testimonial__slider__active default__arrow" data-aos="fade-up">
                        ...
                        <div class="single__testimonial__wraper">
                            <div class="single__testimonial__inner">
                                <div class="testimonial__img">
                                    <img style="width: 80px; height: 80px;" src="img/testimonial/student_3.png" alt="testi">
                            ...
                            <div class="testimonial__content">
                                <p>Webdeves Academy taught me how to build a website from scratch, including blog sites and business websites. Thank you Webdeves Academy. I am grateful for the knowledge you have impacted to me.</p>
                            </div>
                    ...
                    <div class="col-xl-6 column__custom__class">
                        <div class="single__testimonial__wraper">
                            <div class="single__testimonial__inner">
                                <div class="testimonial__img">
                                    <img style="width: 80px; height: 80px;" src="img/testimonial/student_2.png" alt="testi">
                                    <div class="testimonial__name">
                                        <h6>TOYIN</h6>
                            ...
                            <div class="testimonial__content">
                                <p>Webdeves Academy has been really a great source of inspiration to me and to the society. The have opened my eyes and mind to a whole new perspective of possibilities in the tech world. They always look at bringing solutions to the problems of the society</p>
                            </div>
                    ...
                    <div class="col-xl-6 column__custom__class">
                        <div class="single__testimonial__wraper">
                            <div class="single__testimonial__inner">
                                <div class="testimonial__img">
                                    <img style="width: 80px; height: 80px;" src="img/testimonial/student_1.png" alt="testi">
                                    <div class="testimonial__name">
                                        <h6>ELLA</h6>
                            ...
                            <div class="testimonial__content">
                                <p>Their practical aspects of the training is like a WOW!!  their environment very conducive and comfortable....Kudos to them. they deserve the best..</p>
                            </div>
                    ...
                    <div class="col-xl-6 column__custom__class">
                        <div class="single__testimonial__wraper">
                            ...
                            <div class="testimonial__content">
                                <p>Choosing Webdeves Academy was the best decision I ever made. I'm proud to be an alumnus of Webdeves Academy and grateful for the opportunities it has provided.</p>
                            </div>
        ...
        <div class="gallery bg-light ">
            <div class="container-fluid full__width__padding  ">
                <div class="blogsidebar__content__wraper__2">
                    <div class="section__title__heading pb-4">
                        <h2 style="color:#170F2F; text-align: center;">Webdeves Students</h2>
                    </div>

                    <div class="photo__gallery__img">

                        <div class="single__gallery__img">
                            <img src="img/blog/IMG_0283.jpg" alt="photo">
                            <div class="gallery__icon">
                                <a class="popup__img" href="img/blog/IMG_0283.jpg"> <i class="icofont-eye-alt"></i></a>
                            </div>
                        </div>
                        <div class="single__gallery__img">
                            <img src="img/blog/IMG_0019.jpg" alt="photo">
                            <div class="gallery__icon">
                                <a class="popup__img" href="img/blog/IMG_0019.jpg"> <i class="icofont-eye-alt"></i></a>
                            </div>
                        </div>
                        <div class="single__gallery__img">
                            <img src="img/blog/IMG_0014.jpg" alt="photo">
                            <div class="gallery__icon">
                                <a class="popup__img" href="img/blog/IMG_0014.jpg"> <i class="icofont-eye-alt"></i></a>
                            </div>
                        </div>
                        <div class="single__gallery__img">
                            <img src="img/blog/IMG_0275.jpg" alt="photo">
                            <div class="gallery__icon">
                                <a class="popup__img" href="img/blog/IMG_0275.jpg"> <i class="icofont-eye-alt"></i></a>
                            </div>
                        </div>
                        <div class="single__gallery__img">
                            <img src="img/blog/IMG_0010.jpg" alt="photo">
                            <div class="gallery__icon">
                                <a class="popup__img" href="img/blog/IMG_0010.jpg"> <i class="icofont-eye-alt"></i></a>
                            </div>
                        </div>
                        <div class="single__gallery__img">
                            <img src="img/blog/IMG_0016.jpg" alt="photo">
                            <div class="gallery__icon">
                                <a class="popup__img" href="img/blog/IMG_0016.jpg"> <i class="icofont-eye-alt"></i></a>
                            </div>
                        </div>

                        <div class="single__gallery__img">
                            <img src="img/blog/webdeves-student-4.JPG" alt="photo">
                            <div class="gallery__icon">
                                <a class="popup__img" href="img/blog/webdeves-student-4.JPG"> <i
                                        class="icofont-eye-alt"></i></a>
                            </div>
                        </div>
                        <div class="single__gallery__img">
                            <img src="img/blog/webdevesstudent1.jpg" alt="photo">
                            <div class="gallery__icon">
                                <a class="popup__img" href="img/blog/webdevesstudent1.jpg"> <i
                                        class="icofont-eye-alt"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="w-100 d-flex justify-content-around align-items-center mt-3">
                        <div>
                            <a class="default__button hreobannerarea__button__3"
                                href="https://facebook.com/webdevesacademy/photos" target="_blank">View More</a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        <div class="herobannerarea__content__wraper">
                            ...
                            <div class="herobannerarea__text herobannerarea__text__2">
                                <p>Are you ready to embark on your educational journey with <br> Webdeves Acadamy?
                                    Discover your passion, unlock your <br> potential, and shape your future to match
                                    amazing <br> opportunities waiting for you at out there!</p>
                            </div>
                            <div class="hreobannerarea__button__2">
                                <a class="default__button" href="course.html">View Courses</a>
                                <a class="default__button hreobannerarea__button__3" href="registration.html">Register
                                    Now</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        ...
                        <div class="herobanner__video registerarea__video">
                            <img src="img/herobanner/herobanner__video.jpg" alt="Video Banner">

                            <div class="video__pop__btn">
                                <a class="video-btn" href="https://www.youtube.com/watch?v=gqt4Bg-VnU8"> <img
...
<?php include('./resources/view/layout/footer.php'); ?>
    </main>
...
<?php include('./resources/view/layout/foot.php'); ?>
